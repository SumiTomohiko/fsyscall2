...
DUMMY_SYSCALLS = [
        ...
        "fmaster_getsockname", "fmaster_chflags", "fmaster_fchflags",
        "fmaster_sync", "fmaster_kill", "fmaster_getppid", "fmaster_profil",
        "fmaster_ktrace", "fmaster_getlogin", "fmaster_setlogin",
        "fmaster_acct", "fmaster_reboot", "fmaster_revoke", "fmaster_symlink",
        "fmaster_execve", "fmaster_umask", "fmaster_chroot", "fmaster_msync",
        "fmaster_vfork", "fmaster_ovadvise", "fmaster_getgroups",
        "fmaster_setgroups", "fmaster_getpgrp", "fmaster_setpgid",
        "fmaster_setitimer", "fmaster_getitimer", "fmaster_dup2",
        "fmaster_fsync", "fmaster_setpriority", "fmaster_getpriority",
        "fmaster_bind", "fmaster_setsockopt", "fmaster_listen",
        ...
        "fmaster_futimes", "fmaster_getpgid", "fmaster_clock_settime",
        "fmaster_clock_getres", "fmaster_ktimer_create",
        "fmaster_ktimer_delete", "fmaster_ktimer_settime",
        "fmaster_ktimer_gettime", "fmaster_ktimer_getoverrun", "fmaster_rfork",
        "fmaster_lchown", "fmaster_aio_read", "fmaster_aio_write",
        "fmaster_lio_listio", "fmaster_getdents", "fmaster_lchmod",
