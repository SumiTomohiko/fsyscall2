...
DUMMY_SYSCALLS = [
        ...
        "fmaster_lchflags", "fmaster_sendfile", "fmaster_getfsstat",
        "fmaster_statfs", "fmaster_fhstatfs", "fmaster_setcontext",
        "fmaster_swapcontext", "fmaster_thr_create", "fmaster_thr_exit",
        "fmaster_thr_kill", "fmaster_thr_suspend", "fmaster_thr_wake",
