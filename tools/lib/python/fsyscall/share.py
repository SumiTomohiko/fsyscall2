...
DUMMY_SYSCALLS = [
        "fmaster_unlink", "fmaster_fchdir", "fmaster_mknod", "fmaster_chmod",
        "fmaster_chown", "fmaster_mount", "fmaster_unmount", "fmaster_setuid",
        "fmaster_ptrace", "fmaster_recvmsg", "fmaster_sendmsg",
