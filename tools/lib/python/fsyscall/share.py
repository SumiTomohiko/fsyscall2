...
DUMMY_SYSCALLS = [
        ...
        "fmaster_reboot", "fmaster_revoke", "fmaster_symlink", "fmaster_chroot",
        ...
        "fmaster_clock_settime", "fmaster_ktimer_create",
        ...
        "fmaster_lchflags", "fmaster_sendfile", "fmaster_fhstatfs",
        "fmaster_setcontext", "fmaster_swapcontext", "fmaster_thr_create",
        "fmaster_thr_suspend", "fmaster_thr_wake", "fmaster_abort2",
        ...
        "fmaster_wait6", "fmaster_bindat", "fmaster_connectat",
        "fmaster_chflagsat", "fmaster_pipe2", "fmaster_ppoll",
        "fmaster_futimens", "fmaster_utimensat"
        ]
